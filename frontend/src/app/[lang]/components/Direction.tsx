      ...
      >
        <div className="arrow-container w-3/12 lg:ms-32 ms-10">
          <div className="arrow-icon">
            <Image src={arrowIcon} alt="arrow icon" className="lg:ms-[34px]"/>
          </div>
        </div>

        <div className="mb-10 w-8/12 text-right lg:me-32 me-12">
          <p className="lg:text-48 sm:text-13 font-bold text-white ">{data.text1}</p>
        </div>
      </div>

      <div className="bg-white">
        <div className="lg:py-20 py-10 lg:pb-40 flex justify-end lg:me-32 me-12">
          <p className="w-8/12 lg:text-32 sm:text-13 text-right text-greySecondary">
            {data.text2}
          </p>
        </div>
      </div>
